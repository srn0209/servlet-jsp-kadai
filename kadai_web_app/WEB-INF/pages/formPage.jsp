...
<body>
    ...
    <form action="<%= request.getContextPath() %>/confirm" method="post">
        <table>
            <tr><td>お名前</td><td><input type="text" name="user_name" value="<%= userName %>"></td></tr>
            <tr><td>メールアドレス</td><td><input type="text" name="user_email" value="<%= userEmail %>"></td></tr>
            <tr><td>住所</td><td><input type="text" name="user_address" value="<%= userAddress %>"></td></tr>
            <tr><td>電話番号</td><td><input type="text" name="user_phone_number" value="<%= userPhone %>"></td></tr>
        </table>
